...
def jobblissLogin():
    ...
    print("[Info] - Login As a Contractor ............")
    ...
    browser.get('https://alpha.jobbliss.com/profile')
    ...
    try:
        ...
        elem = WebDriverWait(browser, 10).until(
            EC.presence_of_element_located((By.XPATH,'//*[@id="app"]/div/div/div/div[2]/div/div/div/div/div/div[1]/div[2]/div[2]/main/section/section/div/div/div/div[1]/div[1]/div/div/div[2]'))
            # Take a screenshot of the Page and store it for analysis.
        
        )
        image = fscreenshot.full_Screenshot(browser, save_path=r'.', image_name='ContractorLoggedIn.png')
        time.sleep(3)

        header = ['Test Name', 'State']

        #data
        data = ['Contractor Login' 'Passed']
        ...
        with open('AutomationQA_Summary.csv','a',encoding='UTF8', newline='') as f:
           ...
           print("Logged In As a Contractor Successfully")
