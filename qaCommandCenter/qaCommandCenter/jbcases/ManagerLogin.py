...
def jobblissLogin():
    logging.basicConfig(filename='ManagerLogin_log.txt', level=logging.DEBUG, format="%(asctime)s %(message)s",
                        filemode='w')
    # Complete these 2 fields ==================
    USERNAME = 'anesu+manager1@velocityinc.tech'
    PASSWORD = 'mavaramachena'
    SEARCH = '********'
    # ==========================================
    fscreenshot = Screenshot.Screenshot()
    print("[Info] - Login As a Manager ............")
    ...
    try:
        ...
        image = fscreenshot.full_Screenshot(browser, save_path=r'.', image_name='ManagerLoggedIn.png')
        time.sleep(3)

        header = ['Test Name', 'State']

        #data
        data = ['Manager Login' 'Passed']
        ...
        with open('AutomationQA_Summary.csv','a',encoding='UTF8', newline='') as f:
            ...
            time.sleep(3)
            print("You have Logged In As a Manager Successfully")
